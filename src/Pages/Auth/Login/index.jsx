...
export default function Login() {
    ...
    const onSubmit = async (data) => {
        try {
            await logIn(data);
            ShowMessage({ title: 'Sucesso', text: "Operação realizada com sucesso.", icon: "success" }, () => { navigate("/admin/home") });
        } catch (e) {
            ...
            >
                <Row>
                    <Col sm={12} lg={12}>
                        ...
                        <h5>Se você é um doador, por favor clique <span className='text-primary' style={{cursor: "pointer"}} onClick={() => navigate("/auth/formulario")}>aqui</span> para contribuir.</h5>
                    </Col>
                </Row>
            </ModalCustom>
            <Container>
