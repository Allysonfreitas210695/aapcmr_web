      ...
      <Row>
        {relatorios.map((relatorio, index) => (
          <Col sm={12} lg={6} key={index} className='mb-3'>
            <Card style={{ cursor: "pointer" }} className='shadow bg-white rounded shandow-hover' onClick={() => navigate(relatorio.path)}>
              <CardBody className="d-flex flex-column justify-content-center align-items-center">
                  <strong  style={{fontSize: "18px"}} className='mb-3'>{relatorio.name}</strong>
