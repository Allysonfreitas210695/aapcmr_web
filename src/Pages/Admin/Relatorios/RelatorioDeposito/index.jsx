...
export default function RelatorioDeposito() {
  ...
  const loadRelatorioDoacaoDeposito = async () => {
    showLoading(true);
    try {
      let response = await api_POST('RelatorioMensal/RelatorioDoacaoDeposito', {
        dataInicial: null,
        dataFinal: null
      });
      const { data } = response;
  ...
  const exportToExcel = async () => {
    const { totalValorDoacao } = listRelatorioDeposito.reduce(
      (acc, curr) => {
  ...
  const handleFiltroRelatorioMensal = async (data) => {
    ...
    showLoading(true);
    try {
      var response = await api_POST('RelatorioMensal/RelatorioDoacaoDeposito', {
